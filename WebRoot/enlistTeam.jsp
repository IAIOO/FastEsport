...
<!-- 自由修改区域 -->
    ...
    <fieldset>
       ...
       <div class="form-row">
            <div class="field-label"><label for="field4">招募人数</label>:</div>
            <div class="field-widget">
            <e:number step="1" name="aac303" required="true" defval="${ins.aac303 }"/>
			</div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field4">游戏类型</label>:</div>
            <div class="field-widget">
            <e:groupbox name="aac304" value="DOTA2:1,LOL:2,王者荣耀:3,CSGO:4,PUBG:5,OW:6,星际争霸2:7,魔兽争霸3:8,炉石传说:9" 
            newLineNumber="5" defval="${ins.aac304 }" />
			</div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field4">薪资范围</label>:</div>
            <div class="field-widget">
            <e:number step="100" id="baac305" name="aac305" required="true" defval="${ins.aac305 }" onchange="onMoney()"/>
       		——  <e:number step="100" id="eaac310" name="aac310" required="true" defval="${ins.aac310 }" onchange="onMoney()"/>(RMB)
			</div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field4">招募开始日期</label>:</div>
            <div class="field-widget">
            <e:date id="baac306" name="aac306" required="true" defval="${ins.aac306 }" onchange="onDate()"/>
			</div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field4">招募结束日期</label>:</div>
            <div class="field-widget">
            <e:date id="eaac307" name="aac307" required="true" defval="${ins.aac307 }" onchange="onDate()"/>
			</div>
        </div>
        <div class="form-row">
