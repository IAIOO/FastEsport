				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-5" id="cl-effect-5">
						<ul class="nav navbar-nav">
							<li class="active"><a href="index.jsp"><span data-hover="首页">首页</span></a></li>
							<li><a href="#about" class="scroll"><span data-hover="全部赛事"> 全部赛事 </span></a></li>
							<li><a href="#services" class="scroll"><span data-hover="赛事管理"> 赛事管理 </span></a></li>
							<li><a href="#work" class="scroll"><span data-hover="战队管理">战队管理</span></a></li>
							<li><a href="#projects" class="scroll"><span data-hover="论坛天地">论坛天地</span></a></li>
							<li><a href="#mail" class="scroll"><span data-hover="商城中心">商城中心</span></a></li>
						</ul>
					</nav>
				</div>
			</nav>	
...
<!-- footer -->
	<div class="w3l_footer">
		...
		<div class="w3l_footer_pos">
			<p>Copyright &copy; 2017.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="妯℃澘涔嬪">妯℃澘涔嬪</a> - Collect from <a href="http://www.cssmoban.com/" title="缃戦〉妯℃澘" target="_blank">缃戦〉妯℃澘</a></p>
		</div>
	</div>
<!-- //footer -->
